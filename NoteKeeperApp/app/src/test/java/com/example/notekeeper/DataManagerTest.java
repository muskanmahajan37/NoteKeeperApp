...
public class DataManagerTest {
    ...
    public void findSimilarNotes() {
        ...
        final String noteText2 = "This is the body of second text note";
    ...
    public void createNewNoteOneStepCreation() {
        final CourseInfo course = sDataManager.getCourse("android_async");
        final String noteTitle = "Test note title in create new note one step creation";
        final String noteText = "This is the body of the text in create new note ine step creation";
